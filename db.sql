...
(1, 'National Geographic', 'A monthly magazine about science, geography, history, and world culture', TRUE, '2024-05-01', NULL, NULL, NULL, 120, 'https://example.com/covers/natgeo.jpg'),
(2, 'TIME', 'A weekly news magazine', FALSE, '2024-04-28', '2024-05-10', '2024-05-20', 201, 75, 'https://example.com/covers/time.jpg'),
(3, 'The Economist', 'A weekly magazine focusing on current affairs, international business, politics, technology, and culture', TRUE, '2024-05-15', NULL, NULL, NULL, 95, 'https://example.com/covers/economist.jpg'),
(4, 'Forbes', 'Bi-weekly business magazine', TRUE, '2024-05-05', NULL, NULL, NULL, 85, 'https://example.com/covers/forbes.jpg'),
(5, 'Scientific American', 'Monthly magazine bringing scientific discoveries and research to the public', FALSE, '2024-04-20', '2024-04-30', '2024-05-15', 202, 110, 'https://example.com/covers/scientific.jpg'),
(6, 'Popular Science', 'Monthly magazine on current science and technology news', TRUE, '2024-05-10', NULL, NULL, NULL, 90, 'https://example.com/covers/popularscience.jpg'),
(7, 'Vogue', 'Monthly fashion and lifestyle magazine', FALSE, '2024-04-15', '2024-05-01', '2024-05-10', 203, 150, 'https://example.com/covers/vogue.jpg'),
(8, 'National Geographic Traveler', 'A bi-monthly travel magazine', TRUE, '2024-05-12', NULL, NULL, NULL, 130, 'https://example.com/covers/natgeotravel.jpg'),
(9, 'Wired', 'Monthly magazine focusing on how emerging technologies affect culture, the economy, and politics', TRUE, '2024-05-08', NULL, NULL, NULL, 80, 'https://example.com/covers/wired.jpg'),
(10, 'Fortune', 'Bi-weekly magazine covering business, investing, technology, and management', FALSE, '2024-04-25', '2024-05-05', '2024-05-18', 204, 100, 'https://example.com/covers/fortune.jpg');
